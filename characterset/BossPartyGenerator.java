...
import interfaces.IVillainGenerator;
...
public class BossPartyGenerator implements IVillainGenerator
{
	private ArrayList<IVillain> villains;
	
	public BossPartyGenerator() 
	{
	...
	public IParty generateVillains(int numVillains)
	{
		...
		villain = new BossDragon(skillList);
		villainsParty.addChar(villain);
		
		
		
		for(i = 1; i < numVillains; i++)
		{	
