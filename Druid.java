...
public class Druid extends Hero {
	...
	public Druid() 
	{
		super("Druid", 110, 45, 55, 45, 5, 20, 85, 1);

		IAttack attack = new NormalMeleeAttack();
		this.attackList.addAttack(attack);
	}
	
	public Druid(String name, int hpMax, int attackMin, int attackMax, int speed, int phyDefense, int magDefense, int accuracy, int level)
	{
